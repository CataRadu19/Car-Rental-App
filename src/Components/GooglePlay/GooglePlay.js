            ...
            <div className="google-play-small">
                <div className="google-play-container">
                    ...
                    <div className="google-play-buttons">
                        <a href="https://car-rental-radu-catalin.netlify.app"><img src={appstore} alt="google-play" /></a>
                        <a href="https://car-rental-radu-catalin.netlify.app/"><img src={appstore2} alt="google-play" /></a>
                    </div>
                </div>
            </div>
        </div>
